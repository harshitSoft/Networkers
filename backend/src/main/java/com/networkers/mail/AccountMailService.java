...
public class AccountMailService {
    ...
    private String template(String name,String email,String password){return """
      ...
      <tr><td style='padding:22px 32px;background:#000;text-align:center'><img src='https://networkers.family/brand/networkers-email-logo.png' alt='Networkers' width='360' style='display:block;max-width:100%;height:auto;margin:auto'></td></tr>
