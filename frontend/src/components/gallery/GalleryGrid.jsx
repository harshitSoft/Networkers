    ...
    <div className="mx-auto grid max-w-6xl gap-5 px-4 sm:grid-cols-2 lg:grid-cols-3">
      {items.map((item) => (
        <button
          ...
          type="button"
          onClick={() => onOpen(item)}
          className="image-frame group relative min-h-[260px] overflow-hidden rounded-3xl bg-[#111] text-left focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#FF1E1E]"
        >
