...
export default function EmptyState({ title = "Nothing here yet", message = "When data is available, it will appear here.", actionLabel, actionTo, icon: Icon = PlusCircle }) {
  return (
